...
## I2C Interface
 ...
 เนื่องจากระบบของ ARDUINO NANO ใช้แรงดัน 5V จึงต้องใช้ I2C ที่แรงดัน 5V  โดยใช้ resistor pull up ภายนอกขนาดขนาด 1k - 4.7k เข้ากับแรงดัน 5V ทั้งนี้ nucleo สามารถใช้pullup ดังกล่าวในการจ่าย สัญญาณI2C ให้แก่ end effector ได้
 
 แต่ละคำสั่งใน i2C ควรมีระยะห่างระหว่าง stop ของ ของคำสั่งที่แล้วและstart ของคำสั่งปัจจุบันอย่างน้อย 10 ms
